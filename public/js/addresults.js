...
const addBtn = document.querySelector("#addResults");
...
addBtn.onclick = function () {
  ...
  const cdc = document.querySelector("#cdc");
  const cdc = cdc.value;

  const jp = document.querySelector("#jp");
  const jp = jp.value;

  const anpp = document.querySelector("#anpp");
  const anpp = anpp.value;

  const labo = document.querySelector("#labo");
  const labo = labo.value;
